...
final class BoggleHomeViewController: UIViewController {
    ...
    private func setupBoard() {
        ...
        for row in 0..<gridSize {
            ...
            for col in 0..<gridSize {
                ...
                let yPosition = CGFloat(row) * (buttonSize + padding) + 165
    ...
    private func setupWordLabel() {
        ...
        inferenceLabel.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 100).isActive = true
    }
    ...
    private func setupSignButton() {
        ...
        signButton.topAnchor.constraint(equalTo: containerView.topAnchor, constant: boardHeight + 240).isActive = true
